...
class main_listener implements EventSubscriberInterface
{
	...
	*/
	public function codebox_template($code = '', $lang = '', $file = '', $id = 0, $part = 0)
	{
		...
		$re .= '<span class="codebox_plus_about"><a href="http://qbnz.com/highlighter/" target="_blank">GeSHi</a> &copy; <a href="https://github.com/ahkscript/phpBB-Extension-Codebox-Plus" target="_blank">Codebox Plus</a></span>';
